...
const Contact = () => {
		...
		const handleSubmit = (e) => {
			...
			axios.post('https://sheet.best/api/sheets/e4fb9d14-c91c-4572-81f3-f771b0b02701',
			form).then((response) => {
			...
			<div className="contact__container container grid">
				<div className="contact__content">
					<div className="contact__card">
						...
						<p className="contact__card-data">Balasore, Odisha</p>
					</div>
					...
					<div className="contact__card">
						...
						<p className="contact__card-data">piladebajyoti131@gmail.com</p>
					</div>
					...
					<div className="contact__card">
						...
						<p className="contact__card-data">+91 9583394025</p>
					</div>
				</div>
